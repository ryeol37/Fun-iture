...
public class NoticePaging {
	...
	// 페이징 생성자
	public NoticePaging(int currentPage, int totalCount, int blockCount, int blockPage, String viewName) {
		...
		if (currentPage > blockPage) {
			pagingHtml.append("<a class='page prv' href=" + "?page=" + (startPage - 1) + ">");
		...
		if (totalPage - startPage >= blockPage) {
			pagingHtml.append("<a class='page next' href=" + "?page=" + (endPage + 1) + ">");
	...
	// 페이징 생성자
		public NoticePaging(int currentPage, int totalCount, int blockCount, int blockPage, String viewName
				,int searchOption, String search) {
			...
			if (currentPage > blockPage) {
				...
				pagingHtml.append("&searchOption="+searchOption+"&search="+search+">");
				pagingHtml.append("<p class=\"fa fa-hand-o-left\"></p>");
				pagingHtml.append("</a>");
			}
