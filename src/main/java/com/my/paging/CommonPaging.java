...
public class CommonPaging {
	...
	// 페이징 생성자
	public CommonPaging(int currentPage, int totalCount, int blockCount, int blockPage, String viewName) {
	...
	// 페이징 생성자
	public CommonPaging(int currentPage, int totalCount, int blockCount, int blockPage, String viewName
			,String searchCate, String keyword, String scltCate) {
		...
		if (currentPage > blockPage) {
			pagingHtml.append("<a class='page prv' href="+viewName+"?page=" + (startPage - 1));
			pagingHtml.append("&searchCate="+searchCate+"&keyword="+keyword+"&slctCate="+scltCate+">");
			pagingHtml.append("<p class=\"fa fa-hand-o-left\"></p>");
			pagingHtml.append("</a>");
		}
