...
<div class="sign_grp">
	...
	<div class="idpw_grp">
		<form action="findPw" method="post" name="memberFindForm" onsubmit="return memberFindChk()" >
			<fieldset>
				<br>
				
				<div class="tbl_type_03">
					<table>
						<caption>아이디,이메일로 비밀번호 찾기</caption>
						<colgroup>
						...
						<tbody>
							<tr>
								<th scope="row">아이디</th>
								<td><input type="text" class="txt w220" name="id" /></td>
							</tr>
							<tr>
								<th scope="row">이메일</th>
