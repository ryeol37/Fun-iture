...
<script type="text/javascript">
	...
	function cancel(){
		...
		document.frmMain.action = "/funiture/main";
...
<div class="sign_grp">
	...
	<form id="frm" name="frmMain">
		...
		<div class="sign_box">
			<p class="tit"><span><img src="/funiture/resources/images/icon/sign_01.png" alt="약관동의" /></span>약관동의</p>
			<div class="step_01">
				<div class="inner">
					<p>이용약관</p>
...
이 약관은 Fun-iture 회사(전자거래 사업자)가 운영하는 Fun-iture 사이버 몰(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다. 
※ 「PC통신등을 이용하는 전자거래에 대해서도 그 성질에 반하지 않는한 이 약관을 준용합니다」 


제2조(정의)

① "몰"이란 Fun-iture 회사가 재화 또는 용역을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화 또는 용역을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다. 
...
② "몰"과 이용자간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
				...
				<div class="inner">
					...
					<div class="scroll_box" style="height:300;">
						<p>
							제1조. (개인정보의 처리 목적) 
							이 약관은 Fun-iture(주)(이하 '회사'라 합니다)가 제공하는 온라인, 오프라인 서비스(이하 "서비스"라 합니다) 이용과 관련하여 회사와 이용자의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다. 
							가. 서비스 제공 
