...
function click_deposit(){
   ...
   $("[name=depositname]").attr("required",true);
}
...
function click_card(){
   ...
   $("[name=card_cvc]").attr("required",true);
   $("[name=card_month]").attr("required",true);
   $("[name=card_year]").attr("required",true);
   $("[name=cardpass]").attr("required",true);
}
      ...
      <div class="container wrapper">
            <div class="row cart-head">
               ...
               <div class="row cart-body ">
                <form class="form-horizontal" name="orderForm" method="post" action="/funiture/order/orderOk" onsubmit="return check();">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                <div class="col-md-12">
                                    <strong>휴대전화:</strong>
                                    <input type="text" name="phone" id="phone" class="form-control" maxlength="13" required />
                               </div>
                            </div>
                            <div class="form-group">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 col-md-pull-6 col-sm-pull-6">
                   <!--REVIEW ORDER-->
                    <div class="panel panel-default">
                        <div class="panel-heading">
                               결제 목록 <div class="pull-right"></div>
                        </div>
                        <div class="panel-body">
                            <div class="form-group">
                                <div class="col-sm-3 col-xs-3">
                                    <img class="img-responsive" src="/funiture/resources/goodsImage/${goodsModel.main_save}" />
                                </div>
                                <div class="col-sm-6 col-xs-6">
                                    <div class="col-xs-12">${goodsModel.goods_name}</div>
                                    <div class="col-xs-12"><small>수량:<span>${goodsModel.goods_qty}</span></small></div>
                                </div>
                                <div class="col-sm-3 col-xs-3 text-right">
                                    <h6>${goodsModel.goods_price*goodsModel.goods_qty}<span>원</span></h6>
                                    <c:set var= "total" value="${goodsModel.goods_price * goodsModel.goods_qty}"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-xs-12">
                                    <strong>구매 금액</strong>
                                    <div class="pull-right"><span><fmt:formatNumber value="${total}" type="number"/></span><span>원</span></div>
                                </div>
                                <div class="col-xs-12">
                                    <small>배송비</small>
                ...
                <input type="hidden" name="goods_qty" value="${goodsModel.goods_qty }"/>
                <input type="hidden" name="goods_price" value="${goodsModel.goods_price }"/>
