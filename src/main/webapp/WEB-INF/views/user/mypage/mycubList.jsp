...
<div id="contents">
	<div class="inner">
		...
		<div
			...
			<ul class="menu">
				...
				<li class="selected"><a href="<%=cp%>/mypage/mycubList">주문제작</a></li>
	...
	<div class="xans-element- xans-myshop xans-myshop-boardpackage ">
        ...
        -->
			<table border="1" summary="">
				...
				<tbody class=" center">
					<c:forEach var="cubList" items="${cubList}"
						varStatus="stat">
						...
						<tr class="xans-record-">
							...
							<td class="left subject">
								...
								<a href="/funiture/cuboard/view?cub_no=${cubList.cub_no}">${cubList.subject}</a>
							</td>
							<td>${cubList.id}</td>
							<td><span class="txtNum"><fmt:formatDate
										value="${cubList.reg_date}" pattern="YYYY-MM-dd" /></span></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
			<c:if test="${fn:length(cubList) le 0}">
				<br />
				<center>의뢰 내역이 없습니다.</center>
				<br />
			</c:if>
		</div>
	...
	<form id="boardSearchForm" name="search" action="/funiture/mypage/mycubList"
		method="post">
