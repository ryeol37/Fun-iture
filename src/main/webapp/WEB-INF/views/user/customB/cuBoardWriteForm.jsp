...
<div class="product">
	<div class="container">
		...
		<input type="hidden" name="optionDefault" value="${optionDefault}"/> 
			<div class="col-lg-6 col-md-6">
				<div class="panel panel-default">
					<div class="panel-top">선택하신 상품 : ${name}</div>
					...
					<div class="panel-footer">Customizing Service : 더 원하시는 조건이 있다면 입력해주세요!</div>
				</div>
			</div>
			<!-- /.col-lg-6 -->
			<div class="col-lg-6 col-md-6">
					...
					<div class="panel-body">
						...
						<div class="col-md-12 register-top-grid">
							...
							<div style="padding-bottom:20px">
								<span>첨부파일(.jpg 또는 .png 또는 .zip 형식으로 업로드해주세요.)</span>
			...
			<!-- /.col-lg-6 -->
			<div class="col-md-12 register-bottom-grid" style="padding-top:20px;vertical-align:middle;text-align:center">
				<input type="submit" value="견적문의하기">
				<a href="#" class="list"><input type="button" value="주문제작 상품 다시 고르기"></a>
			</div>
			<div class="clearfix"></div>
		</form>
	</div>
...
$(document).ready(function(){
	...
	$(".list").click(function(e){
		e.preventDefault();
		location.href='../custom/list?page=1';
	});
});
</script>