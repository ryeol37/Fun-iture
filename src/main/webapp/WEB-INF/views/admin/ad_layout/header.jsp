...
<script type="text/javascript">
	function check_admin(){
		var id = document.getElementsByName("adminCheck")[0].value;
		if(id=='' || id!== 'admin'){
			alert("관리자 로그인이 필요합니다.");
			location.href = "/funiture/ad/loginform";
		}
	}
</script>
...
<input type="hidden" name="adminCheck" value="${session_id}"/>
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/funiture/admemberList">Fun-iture</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
               			...
               			<c:if test="${ session_name == 'admin'  }">
                        <li><a href="<%=cp %>/admemberList"><i class="fa fa-user fa-fw"></i> MemberList</a>
                        </li>
                        <li><a href="#"><i class="fa fa-gear fa-fw"></i> Settings</a>
                        </li>
                        <li class="divider"></li>
                        <li><a href="<%=cp %>/at_logout"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                        </li>
                       </c:if>
<!--                     </ul>
                    ...
                    <ul class="dropdown-menu dropdown-user"> -->
                     <c:if test="${ session_name == null  }">
                        <li><a href="#none" onclick="check_admin()"><i class="fa fa-user fa-fw"></i> MemberList</a>
                        </li>
                        <li><a href="#none" onclick="check_admin()"><i class="fa fa-gear fa-fw"></i> Settings</a>
                        </li>
                        <li class="divider"></li>
                        <li><a href="<%=cp %>/at_loginform"><i class="fa fa-sign-out fa-fw"></i> Login</a>
                        </li>
                           </c:if>
                    </ul>
