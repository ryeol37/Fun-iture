        ...
        <div id="page-wrapper">
            <div class="container-fluid">
               ...
               <div class="row cart-body ">
                <form class="form-horizontal" name="adOrderModiForm" method="post" action="/funiture/adOrderModify">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 col-md-push-3 col-sm-push-3">
                   <!--SHIPPING METHOD-->
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-xs-12">
                                    <strong>우편번호:</strong>
                                    <input type="text" id="zipcode" name="zipcode" class="form-control" value="${orderModel.zipcode }" required/>
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-xs-12">
                                    <strong>기본주소:</strong>
                                    <input type="text" name="address1" id="address1" class="form-control" value="${orderModel.address1 }" required/>
                                </div>

                                <div class="col-md-6 col-xs-12">
                                    <strong>상세주소:</strong>
                                    <input type="text" name="address2" id="address2" class="form-control" value="${orderModel.address2 }" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" class="form-control" name="memo" value="${orderModel.memo }"/>
                                </div>
                            </div>
                            <div class="form-group">
                            	<div class="col-md-12"><strong>배송 상태:</strong></div>
                            	<div class="col-md-12">
									<select id="status_no" name="status_no" class="form-control" >
										<option value="${orderModel.status_no }">${orderModel.status}</option>
										<option>===========</option>
										<option value=1>입금 대기 중</option>
	                                    <option value=2>상품 준비 중</option>
	                                    <option value=3>배송 중</option>
	                                    <option value=4>배송 완료</option>
	                                    <option value=8>주문 취소</option>
	                                    <option value="10">교환 요청</option>
	                                    <option value="11">교환 완료</option>
	                                    <option value=6>반품 요청</option>
                    ...
                    <input type="hidden" name="use_point" value="${orderModel.use_point }"/>
                    <button type="submit" class="btn btn-default btn-submit-fix pull-right">수정하기</button>
                    <button type="button" class="btn btn-default pull-right" onclick="location.href='/funiture/adOrderList'">목록</button>
                </div>
                </form>
            </div>
                </div>
