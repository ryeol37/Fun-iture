        ...
        <div id="page-wrapper">
            <div class="container-fluid">
               ...
               <div class="row cart-body ">
                <form class="form-horizontal" name="adOnedayModiForm" method="post" action="/funiture/adCusOrderModify" >
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 col-md-push-3 col-sm-push-3">
                   <!--SHIPPING METHOD-->
                    ...
                    <button type="button" class="btn btn-default pull-right" onclick="location.href='/funiture/adCustomList'">목록</button>
                </div>
                </form>
            </div>
                </div>
