...
<div id="page-wrapper">
            <div class="row">
				...
				<form:form commandName="member" action="admemberModify" method="post" name="admemberModify">	
				...
				<table>
						...
						<tr>
							...
							<tr>
								<th scope="row">포인트</th>
								<td>
									<form:input type="text" path="point"  value="${member.point}"/>
								</td>
							</tr>
						</tbody>
					</table>
		...
		<div class="btn_type_04">
			<a href="<%=cp %>/admemberList" class="btn btnC_03 btnF_02 mr10">
				<span>취소</span>
			</a>
